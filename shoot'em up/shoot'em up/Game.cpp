    ...
    do {
        ...
        while (SDL_PollEvent(&event)) {
            ...
            if (currentState == State::MENU) {
                // Traiter TOUS les �v�nements pour le menu
